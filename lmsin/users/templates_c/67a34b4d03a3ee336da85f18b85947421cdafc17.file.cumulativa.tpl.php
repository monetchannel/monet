<?php /* Smarty version Smarty-3.0.6, created on 2015-04-04 02:35:22
         compiled from "./templates/cumulativa.tpl" */ ?>
<?php /*%%SmartyHeaderCode:620541514551fb05aeb59b3-06370855%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '620541514551fb05aeb59b3-06370855',
  'function' => 
  array (
  ),
...
<div class="col-md-12" style="background-color:#ECECEC; height:100%;padding-top: 10px;" >
    <div class="top-title" style="margin-top:-10px;margin-left:-20px;margin-right:130px;position:relative;background:#ECECEC;font-size:16px;"><b>My Last Redemption</b></div>
    	<table class="user-expression table table-bordered"> 
            <tbody>
                <tr class="" style="border-bottom:0">
                    <?php if ($_smarty_tpl->getVariable('last_rdm')->value>0){?>
