<?php /* Smarty version Smarty-3.0.6, created on 2015-04-15 07:45:46
         compiled from ".\templates\index_home.tpl" */ ?>
<?php /*%%SmartyHeaderCode:23921552dfb0aaa67d4-62628102%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '23921552dfb0aaa67d4-62628102',
  'function' => 
  array (
  ),
...
function sign($op)
{
	if($op==1)
	{
		window.location.href=SERVER_PATH+'lmsin/users/index.php?act=show_login&msg=sign_in';
		return true;
	}
        if($op==2)
	{
		window.location.href=SERVER_PATH+'lmsin/users/index.php?act=show_login&msg=sign_up';
		return true;
	}
}
</script> 
