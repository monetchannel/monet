		...
		<div id="wrapper">
			<div id="sidebar-wrapper" style="margin-top:-6px;position:fixed;">
				<ul class="sidebar-nav dashboard">
					...
					<li  style="border-bottom:0px";"padding-bottom:0";class="{$reward_tab}">
						{if $reward_tab==''}
						...
						{/if}
						<ul id="accordionfour" style=" margin-left:40px;background:#FFFFFF;"class="panel-collapse collapse" {if $reward_tab!=''}display:block {/if}">
					...
					<li  style="border-bottom:0;"padding-bottom:0" class="{$fame_tab}">
						{if $fame_tab==''}
						...
						{/if}
						<ul id="accordionthree"style=" margin-left:40px;background:#FFFFFF;" class="panel-collapse collapse"  {if $fame_tab!=''}display:block {/if}">
