...
<div style="width:750px; border:1px solid #c0c0c0; border-top:none; font-family:Tahoma, Geneva, sans-serif; font-size:15px;">
  ...
  <tr>
    <td>{$resp_name} has responded on your challenge for the video:</td>
  </tr>
   <tr>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td><a href="{$title_link}">{$c_title}</a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td><div style="background-color:#67a7e4; color:#ffffff; padding-top:5px; text-align:center; width:200px; height:25px"><a href="{$SERVER_PATH}monet_channel.php" style="text-decoration:none;
	color:#ffffff;">Click here to view the rating.</a></div> </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
