    ...
    <tr>
      <td width="100%" >
        <table width="100%" cellpadding="0" cellspacing="1" id="List2" height="45">
          <tr bgcolor="#333333">
            <td bgcolor="#EEEEEE" width="29%" align="left" class="tablehead"><a href="javascript: set_order('company_name','{$company_name_order}')"> Name</a></td>
            <td bgcolor="#EEEEEE" width="36%" align="center" class="tablehead"><a href="javascript: set_order('company_email','{$company_email_order}')">Email Id</a></td>
            <td bgcolor="#EEEEEE" width="22%" align="center" class="tablehead"><a href="javascript: set_order('company_address','{$company_address_order}')">Address</a></td>
...
{strip}
          <tr bgcolor="#ffffff">
            <td height="16" class="tabletext" >{$invitation_request.company_name}</td>
            <td  align="left" class="tabletext" >{$invitation_request.company_email}</td>
            <td  align="left" class="tabletext" >{$invitation_request.company_address}</td>
            <td  align="left" class="tabletext" ><span class="tabletextred2"><a href="javascript: company.edit('','Edit Company','','','','','','','','{$invitation_request.company_id}',1)">Accept</a><!--<a href="javascript: x_accept_company_invite_request({$invitation_request.company_id},show_company_inv)">Accept</a>--></span>&nbsp;|&nbsp;<span class="tabletextred2"><a href="javascript: company_invitation_del({$invitation_request.company_id})">Deny</a></span></td>
          </tr>
{/strip}
{/foreach}
{$HF2}
