...
{*<script src="https://apis.google.com/js/client:platform.js?onload=render" async defer>
 ...
 function render() {
   ...
   var signinButton = document.getElementById('google_login_button');
...
{*                             <a href="{$Server_View_Path."/user/confirmation.php?act=send_new_email"}">Send new confirmation email...</a>*}
									</div>    
...
<input type="hidden" name="cmp_id" value="{$cmp_id}" id="cmp_id" />	
	  ...
	  <div class="col-md-1 col-sm-1 col-xs-1">
           ...
           <div class="col-md-3 col-sm-4 col-xs-7">
               <div style="margin-top:70%;">
                   <p align="center" style="margin-bottom: 30px;"><a id="FB" href="{$fb_login_url}"><img src="./images/fb.png" class="img-responsive">  </p>
