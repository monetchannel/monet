	...
	<head>
		...
		<![endif]-->
            ...
            var chartData = [
                {
                    "direction": "Happy",
                    "value": {$chart_data.happy.value},
                    "img_src": "{$chart_data.happy.image_path}"
                },
                {
                    "direction": "Sad",
                    "value": {$chart_data.sad.value},
                    "img_src": "{$chart_data.sad.image_path}"
                },
                {
                    "direction": "Angry",
                    "value": {$chart_data.angry.value},
                    "img_src": "{$chart_data.angry.image_path}"
                },
                {
                    "direction": "Disgusted",
                    "value": {$chart_data.disgusted.value},
                    "img_src": "{$chart_data.disgusted.image_path}"
                },
                {
                    "direction": "Neutral",
                    "value": {$chart_data.neutral.value},
                    "img_src": "{$chart_data.neutral.image_path}" 
                    //<img class="img-responsive img-thumbnail emotion-indicator" src="../../uploads/{$u_exp.neutral.ad_id}.jpg">
                },
                {
                    "direction": "Scared",
                    "value": {$chart_data.scared.value},
                    "img_src": "{$chart_data.scared.image_path}"
                },
               
                {
                    "direction": "Surprised",
                    "value": {$chart_data.suprised.value},
                    "img_src": "{$chart_data.suprised.image_path}"
                }
            ];
