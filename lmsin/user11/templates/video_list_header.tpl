			...
			<div id="sidebar-wrapper" style="margin-top:-5px;">
				<ul class="sidebar-nav dashboard">
					...
					<li style="padding-bottom:0" class="">
                                              ...
                                              {else}
                                                <a href="javascript:void(0)" style="background:#f7f7f7; {if $reward_tab!=''}display:block{/if}" >
                                                  <img class="img-responsive rewards" src="./images/rewards.png">Rewards
                                                </a>
                                              {/if}
                                              <ul id="accordiontwo" class="panel-collapse collapse" style="background:#f7f7f7; {if $reward_tab!=''}display:block {/if}">
						...
						{/if}-->
                                               <!--- <ul id="accordionfour" class="panel-collapse collapse" style="background:#ececec;color:#614197; {if $reward_tab!=''}display:block {/if}">
							<li class="sub-nav {$active_cumulative_rewards_tab}" >
