...
function current_user(){
    ...
    $smarty->assign(array("images"=>$images, "UserId"=>$_COOKIE[UserId], "emotions"=>$emotions, "scope"=>"CURRENT", "fame_tab"=>'fame-selected', "active_current_user_tab"=>'label'));//assing values to template
