<?php /* Smarty version Smarty-3.0.6, created on 2015-05-28 17:58:04
         compiled from ".\templates\edit_account.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2336555673b0ce3ef71-38101103%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4f64b2829158e09cf294462d981e2972e9926edc' => 
    array (
      0 => '.\\templates\\edit_account.tpl',
      1 => 1432828669,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2336555673b0ce3ef71-38101103',
  'function' => 
  array (
  ),
...
;
    ...
    <body>
        <?php if ($_smarty_tpl->getVariable('userimage')->value){?>
            <img src="<?php echo $_smarty_tpl->getVariable('userimage')->value;?>
" width="80" height="80">
        <?php }else{ ?>
        ...
        <form id="profile-edit-form" name="edit_form" onsubmit="javascript:return validate_edits()">
            Name: <input type="text" autofocus value="<?php echo $_smarty_tpl->getVariable('user_data')->value['user_fname'];?>
" name="user_fname">
            <input type="text" autofocus value="<?php echo $_smarty_tpl->getVariable('user_data')->value['user_lname'];?>
" name="user_lname">
            <br>
            Birthday: <input type="text" autofocus placeholder="mm/dd/yyyy" value="<?php echo $_smarty_tpl->getVariable('user_data')->value['user_dob'];?>
" name="user_dob">
            <br>
            Email:</label> <input type="text" autofocus value="<?php echo $_smarty_tpl->getVariable('user_data')->value['user_email'];?>
" name="user_email" id="email_field">
            <br>
            Zip: <input type="text" autofocus value="<?php echo $_smarty_tpl->getVariable('user_data')->value['user_zipcode'];?>
" name="user_zipcode">
            <br>
            Country: <select  name="user_country" class="styled-select" style="color:#777;">
                        <?php echo $_smarty_tpl->getVariable('country')->value;?>
