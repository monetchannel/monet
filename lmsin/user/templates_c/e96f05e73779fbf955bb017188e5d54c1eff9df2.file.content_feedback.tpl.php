<?php /* Smarty version Smarty-3.0.6, created on 2015-01-05 05:26:49
         compiled from "./templates/content_feedback.tpl" */ ?>
<?php /*%%SmartyHeaderCode:70044381754aa8309f0f000-88841452%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e96f05e73779fbf955bb017188e5d54c1eff9df2' => 
    array (
      0 => './templates/content_feedback.tpl',
      1 => 1420460800,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '70044381754aa8309f0f000-88841452',
  'function' => 
  array (
  ),
...
"></img> 
 ...
 <?php echo $_smarty_tpl->getVariable('user_data')->value['user_lname'];?>
			...
			<div class="container-fluid" style="position:relative;top:95px;">
				...
				<!-- Top Content -->
				<div class="row ">
					<div class="col-md-10" style="background-color:#F1F1F1; padding-top: 1%;" >
						<!--
								...
								<div  class="col-md-12">
									...
									<div class="row">
										<div class="col-md-3" style="font-size:16px;padding-top:80px">
											<span style="color:#302257;">Your Total Points:</span> <span style="color:#E9576E"><?php echo $_smarty_tpl->getVariable('user_data')->value['points'];?>
</span><br>
										</div>
										<div class="col-md-6">
