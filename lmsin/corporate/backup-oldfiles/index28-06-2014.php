...
//.........................................
$func_ary=array("show_login","chk_login","dashboard","save_ragistration","logout","analysis_results","settings","analysis_graph","import_file","import_do","update_settings","show_analysis_graph","analysis_csv","update_ad_valence","company_profile_edit","company_profile_update");
#############################################################
if (($_COOKIE["CompanyId"]=="" AND $_REQUEST[act]!="show_login" AND $_REQUEST[act]!="chk_login" && $_REQUEST[act]!="save_ragistration"))
{ #not logged in
   show_login();
   return;
}
...
function show_login($msg="" ,$comp_url='')
{
	...
	$smarty->assign(array("msg"=>$msg,"none"=>$none,"SERVER_COMPANY_PATH"=>$Server_company_Path,
						 ...
						 "SERVER_PATH"=>$Server_View_Path,"company_url"=>$R[company_url]));
