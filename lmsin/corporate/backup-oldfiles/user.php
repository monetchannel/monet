...
function user_index($msg='')
{
	...
	$smarty->assign(array("msg"=>$msg,"js"=>$js,"SERVER_PATH"=>$Server_View_Path,
						  ...
						  "SERVER_COMPANY_PATH"=>$Server_company_Path,"SERVER_ADMIN_PATH"=>$Server_View_Path."administrator/"));
...
function user_save($callback,$user_fname,$user_lname,$user_gender,$mm,$dd,$yy,$user_email,$user_max_invites,$user_password)
{
	...
	func_save_user($user_fname,$user_lname,$user_gender,$mm,$dd,$yy,$user_email,$user_max_invites,$user_password,$_COOKIE[CompanyId]);
