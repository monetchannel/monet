...
<div style="width:750px; border:1px solid #c0c0c0; border-top:none; font-family:Tahoma, Geneva, sans-serif; font-size:15px;">
  ...
  <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td><div style="background-color:#67a7e4; color:#ffffff; padding-top:5px; text-align:center; width:200px; height:37px"><a href="{$admin_url}" style="text-decoration:none;
