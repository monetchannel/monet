<?php /* Smarty version Smarty-3.0.6, created on 2015-02-24 07:31:43
         compiled from "./templates/campaign_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:35200399554e2f9a2eb09d0-39809778%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a210b5ac62c792221242f10c01405021df2105a3' => 
    array (
      0 => './templates/campaign_list.tpl',
      1 => 1424161173,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '35200399554e2f9a2eb09d0-39809778',
  'function' => 
  array (
  ),
...
" />
    ...
    <?php if ($_smarty_tpl->getVariable('campaign_num_rows')->value>0){?>
...
?>
                    <tr>
                        <td class="field-label col-xs-2 col-sm-2 col-md-2 text-align">
                            <?php echo $_smarty_tpl->tpl_vars['campaign']->value['cmp_name'];?>

                        </td>
                        <td class="col-md-2  second-td">
                                <?php echo $_smarty_tpl->tpl_vars['campaign']->value['cmp_desc'];?>
                        ...
                        <td class="col-md-5 third-td" >
                            <div class="container-fluid">
                                ...
                                <a href="javascript:void(0)" >
                                <input type="checkbox" name="valence[]" id="Valence_<?php echo $_smarty_tpl->tpl_vars['campaign']->value['cmp_c_id'];?>
" value="valence" class="<?php echo $_smarty_tpl->tpl_vars['campaign']->value['cmp_c_id'];?>
" checked="checked" />
                                <div><label for="Valence_<?php echo $_smarty_tpl->tpl_vars['campaign']->value['cmp_c_id'];?>
">Valence</label></div>
                                </a>
                                
                                <a href="javascript:void(0)">
                                <input type="checkbox" name="microexpressions[]" id="Microexpressions_<?php echo $_smarty_tpl->tpl_vars['campaign']->value['cmp_c_id'];?>
" value="emotion" class="<?php echo $_smarty_tpl->tpl_vars['campaign']->value['cmp_c_id'];?>
" checked="checked" />
                                <div><label for="Microexpressions_<?php echo $_smarty_tpl->tpl_vars['campaign']->value['cmp_c_id'];?>
">Microexpressions</label></div>
                                </a>	
                                
                                <a href="javascript:void(0)">
                                <input type="checkbox" name="engagement[]" id="Engagement_<?php echo $_smarty_tpl->tpl_vars['campaign']->value['cmp_c_id'];?>
" value="attention" class="<?php echo $_smarty_tpl->tpl_vars['campaign']->value['cmp_c_id'];?>
" checked="checked" />
                                <div><label for="Engagement_<?php echo $_smarty_tpl->tpl_vars['campaign']->value['cmp_c_id'];?>
">Engagement</label></div>
                                </a>
                                
                                <a href="javascript:void(0)">
                                <input type="checkbox" name="Heat_map[]" id="Heat_map_<?php echo $_smarty_tpl->tpl_vars['campaign']->value['cmp_c_id'];?>
" value="heatmap" class="<?php echo $_smarty_tpl->tpl_vars['campaign']->value['cmp_c_id'];?>
" checked="checked" />
                                <div><label for="Heat_map_<?php echo $_smarty_tpl->tpl_vars['campaign']->value['cmp_c_id'];?>
">Heat Map</label></div>
                                </a>    
                                
                                <button class="btn btn-sm btn-default" onclick="javascript:return generate_code('<?php echo $_smarty_tpl->tpl_vars['campaign']->value['cmp_c_id'];?>
', '<?php echo $_smarty_tpl->tpl_vars['campaign']->value['cmp_id'];?>
')"><strong>Analyze</strong></button>
                                <input type="hidden" name="vode_id[]" value="<?php echo $_smarty_tpl->tpl_vars['campaign']->value['cmp_c_id'];?>
"  /> 
