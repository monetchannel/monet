<?php /* Smarty version Smarty-3.0.6, created on 2015-02-26 04:41:34
         compiled from "./templates/add_questionaire.tpl" */ ?>
<?php /*%%SmartyHeaderCode:106863173754ef066e56ad45-43612959%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2986b578b7837c19e4034fb13850db6780b855c2' => 
    array (
      0 => './templates/add_questionaire.tpl',
      1 => 1424950883,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '106863173754ef066e56ad45-43612959',
  'function' => 
  array (
  ),
    ...
    <div class="row">
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control input-lg"  name="questiontxt" id="questiontxt" 
                   ...
                   value="<?php echo $_smarty_tpl->getVariable('dataArray')->value['question_text'];?>
"
     ...
     <div class="row">
        <div class="form-group col-md-6">
            ...
            <select id="select_category" name="select_category" class="form-control input-lg" 
                    ...
                    data-rule-required="true"><?php echo $_smarty_tpl->getVariable('dataArray')->value['categorySelectOptions'];?>
</select>
        </div>
    </div>                   
      
    <!--    
    <?php $_smarty_tpl->tpl_vars['loop'] = new Smarty_Variable;$_smarty_tpl->tpl_vars['loop']->step = 1;$_smarty_tpl->tpl_vars['loop']->total = (int)ceil(($_smarty_tpl->tpl_vars['loop']->step > 0 ? 5+1 - (1) : 1-(5)+1)/abs($_smarty_tpl->tpl_vars['loop']->step));
...
$_smarty_tpl->tpl_vars['loop']->first = $_smarty_tpl->tpl_vars['loop']->iteration == 1;$_smarty_tpl->tpl_vars['loop']->last = $_smarty_tpl->tpl_vars['loop']->iteration == $_smarty_tpl->tpl_vars['loop']->total;?>
        <?php $_smarty_tpl->tpl_vars['option_index'] = new Smarty_variable($_smarty_tpl->tpl_vars['loop']->value-1, null, null);?>
    <div class="row">
        <div class="form-group col-md-6">
            <textarea class="form-control input-lg" id="select_option<?php echo $_smarty_tpl->tpl_vars['loop']->value;?>
" name="select_options[]" 
                      placeholder="Option <?php echo $_smarty_tpl->tpl_vars['loop']->value;?>
" rows="6"><?php echo $_smarty_tpl->getVariable('dataArray')->value['mapped_question_options'][$_smarty_tpl->getVariable('option_index')->value];?>
</textarea>
        </div>                      
    </div>  
    <?php }} ?>
    ...
    <div class="row">
        <div class="form-group col-md-6">
            ...
            <input type="radio" id="status" name="status" data-rule-required="true" 
                   <?php if ($_smarty_tpl->getVariable('dataArray')->value['question_status']==0){?> <?php echo 'checked';?>
 <?php }?> data-msg-required="Please select status" value="0" > Private&nbsp;
            <input type="radio" id="status" name="status" data-rule-required="true" 
                   <?php if ($_smarty_tpl->getVariable('dataArray')->value['question_status']==1){?> <?php echo 'checked';?>
 <?php }?>data-msg-required="Please select status" value="1" > Public&nbsp; 
...
">
    <input type="hidden" name="qid" id="qid" value="<?php echo $_smarty_tpl->getVariable('dataArray')->value['qid'];?>
">
