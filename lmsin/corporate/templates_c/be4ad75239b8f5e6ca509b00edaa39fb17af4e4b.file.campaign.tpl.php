<?php /* Smarty version Smarty-3.0.6, created on 2015-02-24 07:31:34
         compiled from "./templates/campaign.tpl" */ ?>
<?php /*%%SmartyHeaderCode:186098461354d3840e324c14-76192164%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'be4ad75239b8f5e6ca509b00edaa39fb17af4e4b' => 
    array (
      0 => './templates/campaign.tpl',
      1 => 1423147914,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '186098461354d3840e324c14-76192164',
  'function' => 
  array (
  ),
            ...
            <table class="table table-bordered"> 
                ...
                <tbody>
                   ...
                   <?php if ($_smarty_tpl->getVariable('assigningValArray')->value['num_rows']>0){?>
                    ...
                    <?php  $_smarty_tpl->tpl_vars['eachcampaign'] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('assigningValArray')->value['campaign_schema']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['eachcampaign']->key => $_smarty_tpl->tpl_vars['eachcampaign']->value){
?>
                        <tr>
                            <td class="col-md-2 second-td"><?php echo $_smarty_tpl->tpl_vars['eachcampaign']->value['cmp_name'];?>
</td>
                            <td class="col-md-3 second-td"><?php echo $_smarty_tpl->tpl_vars['eachcampaign']->value['cmp_desc'];?>
</td>
                            <td class="col-md-2 second-td"><?php echo $_smarty_tpl->tpl_vars['eachcampaign']->value['cmp_start'];?>
</td>
                            <td class="col-md-2 second-td"><?php echo $_smarty_tpl->tpl_vars['eachcampaign']->value['cmp_end'];?>
</td>
                            <td class="col-md-1 fourth-td">
                                <?php if ($_smarty_tpl->tpl_vars['eachcampaign']->value['status']=="1"){?>
                            ...
                            <td class="col-md-2 fourth-td">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <a href="add_campaign.php?cmp_id=<?php echo $_smarty_tpl->tpl_vars['eachcampaign']->value['cmp_id'];?>
&action=edit">
                                    ...
                                    <a onclick="javascript:var res = confirm('Are you really want to delete this campaign ?'); if(res==false){ return false; }" 
                                       href="campaign.php?action=delete&cmp_id=<?php echo $_smarty_tpl->tpl_vars['eachcampaign']->value['cmp_id'];?>
" >
