<?php /* Smarty version Smarty-3.0.6, created on 2015-05-28 06:32:42
         compiled from ".\templates\groups.tpl" */ ?>
<?php /*%%SmartyHeaderCode:27198555d782b520000-94145224%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'eaa05eaeecd251f1ae0d837bfc9e5aff70cf2fba' => 
    array (
      0 => '.\\templates\\groups.tpl',
      1 => 1432188019,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '27198555d782b520000-94145224',
  'function' => 
  array (
  ),
...
">
    ...
    <?php if (isset($_smarty_tpl->getVariable('assigningValArray',null,true,false)->value['deletionStatus'])){?>
        <div class="alert alert-success margin-top">  
          <a class="close" data-dismiss="alert">×</a>  
          <?php echo $_smarty_tpl->getVariable('assigningValArray')->value['deletionStatus'];?>
        ...
        <div class="col-md-12">
            <table class="table table-bordered"> 
                ...
                <tbody>
                   ...
                   <?php if ($_smarty_tpl->getVariable('assigningValArray')->value['num_rows']>0){?>
                    
                    <?php  $_smarty_tpl->tpl_vars['eachgroup'] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('assigningValArray')->value['group_rows']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['eachgroup']->key => $_smarty_tpl->tpl_vars['eachgroup']->value){
?>
                        <?php $_smarty_tpl->tpl_vars['cid'] = new Smarty_variable($_smarty_tpl->tpl_vars['eachgroup']->value['g_id'], null, null);?>
                        <tr>
                            <td class="col-md-2 second-td"><?php echo $_smarty_tpl->tpl_vars['eachgroup']->value['g_name'];?>
</td>
                            <td class="col-md-2 second-td"><?php echo getCompanyName($_smarty_tpl->tpl_vars['eachgroup']->value['g_company_id']);?>
</td>
                            <td class="col-md-2 third-td"><?php echo $_smarty_tpl->tpl_vars['eachgroup']->value['g_subject'];?>
</td>
                            <td class="col-md-3 third-td"><?php echo $_smarty_tpl->tpl_vars['eachgroup']->value['g_desc'];?>
</td>
                            ...
                            <td class="col-md-2 fifth-td">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <a href="add_group.php?group_id=<?php echo $_smarty_tpl->tpl_vars['eachgroup']->value['g_id'];?>
&action=edit" ><img class=""  width="24" height="24" src="./images/view.ico">
                                    <div>View</div>
                                    </a>                                    
                                   
                                    <a onclick="javascript:var res = confirm('Are you really want to delete this group ?'); if(res==false){ return false; }" 
                                       href="groups.php?action=delete&group_id=<?php echo $_smarty_tpl->tpl_vars['eachgroup']->value['g_id'];?>
" >
                ...
                <table class="table">
                    ...
                    <td></td>
                    <td class="text-right">
                        <?php echo $_smarty_tpl->getVariable('assigningValArray')->value['paginationlinks'];?>
