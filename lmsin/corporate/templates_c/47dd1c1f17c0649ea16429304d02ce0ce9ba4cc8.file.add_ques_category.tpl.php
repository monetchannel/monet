<?php /* Smarty version Smarty-3.0.6, created on 2015-02-24 23:35:12
         compiled from "./templates/add_ques_category.tpl" */ ?>
<?php /*%%SmartyHeaderCode:135040003754e58be02d0719-25219393%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '47dd1c1f17c0649ea16429304d02ce0ce9ba4cc8' => 
    array (
      0 => './templates/add_ques_category.tpl',
      1 => 1424329675,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '135040003754e58be02d0719-25219393',
  'function' => 
  array (
  ),
    ...
    <div class="row">
        <div class="form-group col-md-6">
            <input type="text" class="form-control input-lg"  name="category_name" id="category_name" 
                   ...
                   data-rule-required="true" value="<?php echo $_smarty_tpl->getVariable('dataArray')->value['category_name'];?>
    ...
    <div class="row">
        <div class="form-group col-md-6">
            ...
            <select id="select_questions" multiple name="select_questions[]" class="form-control input-lg chosen-select" 
                    ...
                    data-rule-required="true"><?php echo $_smarty_tpl->getVariable('dataArray')->value['questionSelectOptions'];?>
</select>
    ...
    <div class="row">             
        <div class="form-group col-md-6">                                                         
            <label class="cmp_status_label">       
              <input type="checkbox" name="category_status" id="category_status" value="1" <?php echo $_smarty_tpl->getVariable('dataArray')->value['category_status'];?>
  > Active
            </label>          
        </div>            
    </div>            
...
">
    <input type="hidden" name="qcat_id" id="qcat_id" value="<?php echo $_smarty_tpl->getVariable('dataArray')->value['qcat_id'];?>
">
