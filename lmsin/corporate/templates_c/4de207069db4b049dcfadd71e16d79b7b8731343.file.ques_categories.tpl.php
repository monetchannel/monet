<?php /* Smarty version Smarty-3.0.6, created on 2015-02-24 23:35:08
         compiled from "./templates/ques_categories.tpl" */ ?>
<?php /*%%SmartyHeaderCode:70823103254d860df3eecc1-47727698%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4de207069db4b049dcfadd71e16d79b7b8731343' => 
    array (
      0 => './templates/ques_categories.tpl',
      1 => 1423466702,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '70823103254d860df3eecc1-47727698',
  'function' => 
  array (
  ),
            ...
            <table class="table table-bordered"> 
                ...
                <tbody>
                   ...
                   <?php if ($_smarty_tpl->getVariable('assigningValArray')->value['num_rows']>0){?>
                    ...
                    <?php  $_smarty_tpl->tpl_vars['eachQCategory'] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('assigningValArray')->value['qset_schema']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['eachQCategory']->key => $_smarty_tpl->tpl_vars['eachQCategory']->value){
?>
                        <?php $_smarty_tpl->tpl_vars['cid'] = new Smarty_variable($_smarty_tpl->tpl_vars['eachQCategory']->value['question_set_id'], null, null);?>
                        <tr>
                            <td class="col-md-6 second-td"><?php echo $_smarty_tpl->tpl_vars['eachQCategory']->value['question_set'];?>
</td>
                            <td class="col-md-6 second-td">
                            <div class="container-fluid">
                                    <div class="row  action pull-right"> 
                                                                            
                                    <a href="add_ques_category.php?qcat_id=<?php echo $_smarty_tpl->tpl_vars['eachQCategory']->value['question_set_id'];?>
&action=edit" ><img class=""  width="24" height="24" src="./images/edit.png">
                                    ...
                                    <a onclick="javascript:var res = confirm('Are you really want to delete this category ?'); if(res==false){ return false; }" 
                                       href="ques_categories.php?action=delete&qcat_id=<?php echo $_smarty_tpl->tpl_vars['eachQCategory']->value['question_set_id'];?>
" >
