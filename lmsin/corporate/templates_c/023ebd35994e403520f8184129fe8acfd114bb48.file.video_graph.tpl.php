<?php /* Smarty version Smarty-3.0.6, created on 2015-02-07 01:12:29
         compiled from "./templates/video_graph.tpl" */ ?>
<?php /*%%SmartyHeaderCode:105082112054d5c8ed3b4f78-58934296%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '023ebd35994e403520f8184129fe8acfd114bb48' => 
    array (
      0 => './templates/video_graph.tpl',
      1 => 1423147908,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '105082112054d5c8ed3b4f78-58934296',
  'function' => 
  array (
  ),
...
"><a href="index.php?act=company_profile_edit"><img class="img-responsive account" src="images/<?php if ($_smarty_tpl->getVariable('account_tab')->value){?>account_ov.png<?php }else{ ?>account.png<?php }?>"></img>Account</a></li>
                          ...
                          <li class=""><a href="questionaire.php" style="padding-bottom: 5%; background-color: #ececec;">
                                  <img class="img-responsive" src="images/question.png"></img>Questionnaires </a>
                          </li>
            </ul>
        </div>
        <!-- /#sidebar-wrapper -->
