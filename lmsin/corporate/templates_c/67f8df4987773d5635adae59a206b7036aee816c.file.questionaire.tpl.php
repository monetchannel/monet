<?php /* Smarty version Smarty-3.0.6, created on 2015-03-09 00:30:13
         compiled from "./templates/questionaire.tpl" */ ?>
<?php /*%%SmartyHeaderCode:190332893754fd4c05323812-51786359%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '67f8df4987773d5635adae59a206b7036aee816c' => 
    array (
      0 => './templates/questionaire.tpl',
      1 => 1425886179,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '190332893754fd4c05323812-51786359',
  'function' => 
  array (
  ),
        ...
        <div style="margin-top:2%; margin-left: -1%" class="col-xs-8 col-sm-8 col-md-12 ">           
                    ...
                    <div class="srch">
                        ...
                        <select id="category" name="category">
                            ...
                            <?php echo $_smarty_tpl->getVariable('assigningValArray')->value['category_options'];?>

                        </select>
                        
		        <input type="text" class="search-query" value="<?php echo $_smarty_tpl->getVariable('assigningValArray')->value['searchtext'];?>
            ...
            <table class="table table-bordered"> 
                ...
                <tbody>
                   ...
                   <?php if ($_smarty_tpl->getVariable('assigningValArray')->value['num_rows']>0){?>
                    ...
                    <?php  $_smarty_tpl->tpl_vars['eachQ'] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('assigningValArray')->value['questions_schema']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['eachQ']->key => $_smarty_tpl->tpl_vars['eachQ']->value){
?>
                        <?php $_smarty_tpl->tpl_vars['qid'] = new Smarty_variable($_smarty_tpl->tpl_vars['eachQ']->value['q_id'], null, null);?>
                        <tr>
                            <td class="col-md-8 second-td"><?php echo $_smarty_tpl->tpl_vars['eachQ']->value['q_question'];?>
</td>
                            <td class="col-md-4 second-td">
                            <div class="container-fluid">
                                    <div class="row  action pull-right"> 
                                                                            
                                    <a href="add_questionaire.php?qid=<?php echo $_smarty_tpl->getVariable('qid')->value;?>
&action=edit" ><img class=""  width="24" height="24" src="./images/edit.png">
                                    <div>Edit</div>
                                    </a>                                    
                                   
                                    <a onclick="javascript:var res = confirm('Are you really want to delete this question ?'); if(res==false){ return false; }" 
                                       href="questionaire.php?action=delete&qid=<?php echo $_smarty_tpl->getVariable('qid')->value;?>
" >
