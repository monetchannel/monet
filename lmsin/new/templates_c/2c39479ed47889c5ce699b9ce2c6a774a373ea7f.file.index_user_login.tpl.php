<?php /* Smarty version Smarty-3.0.6, created on 2015-01-05 11:39:06
         compiled from ".\templates\index_user_login.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2398054743ed4f01014-07790069%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2398054743ed4f01014-07790069',
  'function' => 
  array (
  ),
  ...
  <nav class="navbar navbar-default" role="navigation">
    <div class="container-fluid"> 
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#"> <img src="images/logo.png" class="img-responsive top-logo" alt="Responsive image"> </a> </div>
...
";
		 ...
		 function chk_login()
		 {
				...
				success: function(js){
					...
					{
						window.location.href=SERVER_PATH+'new/'+js[0];
						return true;
					}
  ...
  function testAPI() {
    ...
    FB.api('/me', function(response) {
		  ...
		  jQuery.ajax({
			...
			data: { "json":json},
			success: function(js){
					location.href='http://www.monetchannel.com/new/watch_video.php'
					return false;
			},
				error: function(){
				alert("Please try again. Server have not sent response.");
